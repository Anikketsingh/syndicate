...
contract Certificates is ERC721 {
    mapping(uint256 => Certificate) CertList;
     ...
     */
    constructor() ERC721("CertCoin", "KCTC") {
    }
     ...
     */
    function issueCert(uint256 ui_Cert_Token_Id, string memory ui_Holder_Name, string memory ui_Holder_ID, string memory ui_Dept, string memory ui_Inst, string memory ui_Cls, string memory ui_Iss_date, address ui_Holder_addr) public isAuthorized {
        Certificate memory cert = Certificate({
            Cert_Token_Id: ui_Cert_Token_Id,
            Holder_Name: ui_Holder_Name,
            Holder_ID: ui_Holder_ID,
            Dept: ui_Dept,
            Inst: ui_Inst,
            Cls: ui_Cls,
            Iss_date: ui_Iss_date,
            Holder_addr: ui_Holder_addr,
            Modify_Reason: ""
        });
     ...
     * @param ui_Cert_Token_Id   Certificate Unique Token ID
     */
    function retrieveCert(uint256 ui_Cert_Token_Id) public view returns (string memory Holder_Name, string memory Holder_ID, string memory Dept, string memory Inst, string memory Cls, string memory Iss_date, address Holder_addr) {
     ...
     */
    function updateCert(uint256 ui_Cert_Token_Id, string memory ui_Holder_Name, string memory ui_Holder_ID, string memory ui_Dept, string memory ui_Inst, string memory ui_Cls, string memory ui_Iss_date, address ui_Holder_addr, string memory ui_reason) public isAuthorized {
        Certificate storage Cid = CertList[ui_Cert_Token_Id];
